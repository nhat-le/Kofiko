function acUnitsStat = fnCollectForceChoiceStats(strctKofiko, strctSync, strctConfig, strctInterval, strOutputFolder)
...
for j=1:length(acTrials)
    acAllOutcomes{j}=acTrials{j}.m_strctTrialOutcome.m_strResult;
end
