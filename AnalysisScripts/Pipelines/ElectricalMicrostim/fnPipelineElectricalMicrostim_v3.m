...
if ~isempty(aiStimulationDuringPassiveFixation)
    % Tricky bit..
      ...
      afFixationSpotSizePix = fnMyInterp1(afFixationSpotChangeTS_PLX,  strctParadigm.FixationSizePix.Buffer,  afAllTrainOnsetsTS_Sorted(aiStimulationDuringPassiveFixation));
       ...
       [aiImageIndex, acImageName, aiDesignIndex, acDesignNames] = fnIdentifyWhichImageWasOnScreenDuringPassiveFixation(strctParadigm, strctSync, afStimulation_TS_Kofiko);
...
function [aiImageIndex, acImageName, aiDesignIndex, acDesignNames] = fnIdentifyWhichImageWasOnScreenDuringPassiveFixation(strctParadigm, strctSync, afSampleTS_Kofiko)
