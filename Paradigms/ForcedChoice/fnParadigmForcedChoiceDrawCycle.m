...
if ~isempty(acInputFromKofiko)
    ...
    switch strCommand
        ...
        case 'ShowFixationSpot'
            ...
            fFlipTime = Screen('Flip', g_strctPTB.m_hWindow); % Blocking !
        ...
        case 'ShowChoice'
            ...
            Screen('Flip', g_strctPTB.m_hWindow); % Blocking !
        ...
        case 'ShowTrial'
            ...
            if strctCurrentTrial.m_fDelayBeforeChoicesMS > 0
                ...
                g_strctDraw.m_fFlipTime1 = Screen('Flip', g_strctPTB.m_hWindow); % Blocking !
                ...
                fnDrawFixationSpot(strctCurrentTrial.m_strctFixation, false);
                fFlipTime1 = Screen('Flip', g_strctPTB.m_hWindow); % Blocking !
...
switch g_strctServerCycle.m_iMachineState
    ...
    case 1
        if g_strctDraw.m_fMemoryIntervalSec > 0
            ...
            if GetSecs() - g_strctDraw.m_fFlipTime1 > g_strctDraw.m_fDelayBeforeChoicesSec - (0.3 * (1/g_strctPTB.m_iRefreshRate) )
                ...
                g_strctDraw.m_fFlipTime2 = Screen('Flip', g_strctPTB.m_hWindow, g_strctDraw.m_fFlipTime1 + g_strctDraw.m_fDelayBeforeChoicesSec); % Blocking !
    ...
    case 2
        if GetSecs() - g_strctDraw.m_fFlipTime2 > g_strctDraw.m_fMemoryIntervalSec - (0.3 * (1/g_strctPTB.m_iRefreshRate) )
             ...
             g_strctDraw.m_fFlipTime3 = Screen('Flip', g_strctPTB.m_hWindow, g_strctDraw.m_fFlipTime1 +  g_strctDraw.m_fMemoryIntervalSec+g_strctDraw.m_fDelayBeforeChoicesSec); % Blocking !
