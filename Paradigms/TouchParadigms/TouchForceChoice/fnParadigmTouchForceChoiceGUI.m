...
%% Mouse
[strctMouseControllers.m_hPanel, strctMouseControllers.m_iPanelHeight,strctMouseControllers.m_iPanelWidth] = ...
    fnCreateParadigmSubPanel(hParadigmPanel,90,iPanelHeight-5,'Mouse');
