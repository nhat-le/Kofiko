...
% NO MOVIE - uses squares.m and circles.m functions
% Copyright (c) 2008 Shay Ohayon, California Institute of Technology.
% This file is a part of a free software. you can redistribute it and/or modify
% it under the terms of the GNU General Public License as published by
% the Free Software Foundation (see GPL.txt)

global  g_strctDraw g_strctStimulusServer g_st`ctPTB
...
%                     fChoicesOnsetTS =fnInitializeMovie(hPTBWindow);
%                     fnKeepPlayingMovie(hPTBWindow);
            ...
            %JCL
            %if g_strctDraw.m_strctCurrentTrial.m_strctChoices.m_bSquares 
                squares(hPTBWindow);
            %end           
