function [strctDesign, bStereoRequired] = fnParsePassiveFixationDesignMediaFiles(strDesignXML, bVerifyExistance, bMessages)
    strctDesign = [];
...
iNumMediaFiles = iNumImages+iNumMovies+iNumStereoMovies+iNumStereoImages;
...
aiOrdering = [aiImageOrdering,aiMovieOrdering,aiStereoImageOrdering,aiStereoMovieOrdering];
astrctMedia = [astrctMonoImages, astrctMonoMovies, astrctStereoImages, astrctStereoMovies];
