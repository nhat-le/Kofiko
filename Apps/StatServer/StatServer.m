function StatServer
global g_bAppIsRunning g_strctConfig  g_strctCycle g_DebugDataLog g_counter g_strctNeuralServer
dbstop if error
...
g_strctConfig.m_strctGUIParams.m_iSystemMouse = 4;
...
strctSettingsPanel.m_hConditionTable = uitable('Position', [10 iHeight-420 iRightPanelWidth-20 200],'parent',strctSettingsPanel.m_hPanel,...
...
strctSettingsPanel.m_hClearAll = uicontrol('style', 'pushbutton','Unit','pixels','Position', [10 iHeight-760 110 30],'parent',strctSettingsPanel.m_hPanel,'string','Clear All','callback',@fnClearAll);
