...
[afX_A, afY_A, apt3fNormals_A,aiDistX_A,aiDistY_A] = fnBuildSmallGrid(a2fR,fShiftX1, fShiftY1,...
                           fOffsetX1, fOffsetY1,...
...
[afX_B, afY_B, apt3fNormals_B,aiDistX_B,aiDistY_B] = fnBuildSmallGrid(a2fR,fShiftX2, fShiftY2,...
                          fOffsetX2, fOffsetY2,...
...
strctGridModel.m_aiLocX       = [aiDistX_A,aiDistX_B];
strctGridModel.m_aiLocY       = [aiDistY_A,aiDistY_B];  
...
function[afGridHolesX, afGridHolesY, apt3fGridNormals,aiDistX,aiDistY] = fnBuildSmallGrid(a2fRMaster,fCenterX, fCenterY,...
                          fOffsetX, fOffsetY,...
...
aiDistX = a2iDistX(a2bFeasible); 
aiDistY = a2iDistY(a2bFeasible);
return;
